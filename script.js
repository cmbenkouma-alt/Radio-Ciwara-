...
/* LECTEUR PRINCIPAL : utilise exactement le widget OnlineRadioBox fourni. */
const mainBox=document.querySelector('.hero-player .direct-player');
if(mainBox){mainBox.innerHTML='<iframe src="player-onlineradiobox.html" title="Lecteur principal Radio Ciwara FM 105.5 MHz" style="display:block;width:100%;height:100px;border:0;overflow:hidden" scrolling="no" allow="autoplay"></iframe>';mainBox.style.padding='0';mainBox.style.overflow='hidden';mainBox.style.background='transparent'}
